$(document).ready(function () {
    ...
    const t = $("#reconsideracionProceso").DataTable({
      data: dataActivos,
      columns: [
    ...
    $("#reconsideracionProceso tbody").on("click", ".btn-eliminar", function () {
    ...
    $("#reconsideracionProceso tbody").on("click", ".btn-editar", function () {
