$(document).ready(function () {
    ...
    const t = $("#personaMoralProspectos").DataTable({
      data: dataActivos,
      columns: [
    ...
    $("#personaMoralProspectos tbody").on("click", ".btn-eliminar", function () {
    ...
    $("#personaMoralProspectos tbody").on("click", ".btn-editar", function () {
