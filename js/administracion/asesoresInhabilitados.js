$(document).ready(function () {
  ...
  const t = $("#tablaInhabilitados").DataTable({
    data: dataActivos,
    columns: [
  ...
  $("#tablaInhabilitados tbody").on("click", ".btn-eliminar", function () {
  ...
  $("#tablaInhabilitados tbody").on("click", ".btn-editar", function () {
  ...
  $("#tablaInhabilitados tbody").on("click", ".btn-mail", function () {
    Swal.fire({
      title: "¿Estás seguro?",
