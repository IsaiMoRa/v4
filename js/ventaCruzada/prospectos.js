$(document).ready(function () {
    ...
    const t = $("#personaFisicaProspectos").DataTable({
      data: dataActivos,
      columns: [
        { title: "Nombre" },
    ...
    $("#personaFisicaProspectos tbody").on("click", ".btn-eliminar", function () {
    ...
    $("#personaFisicaProspectos tbody").on("click", ".btn-editar", function () {
