$(document).ready(function () {
    ...
    const dataActivos = [
      ...
      [
        ...
        "Gerente de ventas",
        "RFCDEMO000",
        `<img src="../../imagenes/descheck.png" alt="Editar" width="20" height="20" />`,
        null,
      ],
      [
        `<a href='#!'  class='iconoTable activeTable'>Comercializador demo</a> `,
    ...
    const t = $("#hipotecarioInactivos").DataTable({
      data: dataActivos,
      columns: [
        { title: "Comercializador de Vivienda" },
    ...
    $("#hipotecarioInactivos tbody").on("click", ".btn-eliminar", function () {
    ...
    $("#hipotecarioInactivos tbody").on("click", ".btn-editar", function () {
