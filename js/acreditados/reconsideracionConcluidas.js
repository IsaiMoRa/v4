$(document).ready(function () {
    ...
    const dataActivos = [
      [
        ...
        "123456789",
        "FolioDemo",
        `<a href='#!'  class='iconoTable activeTable'>ACREDITADP VENTA CRUZADA</a> `,
        "SCOTIABANK CON CLAVE SEA",
        "$00.00",
        "ION CANAL DIRECTO",
        "$00.00",
    ...
    const t = $("#reconsideracionConcluidas").DataTable({
      data: dataActivos,
      columns: [
        { title: "Fecha de envío" },
        { title: "Pedido" },
        { title: "Folio Reconsieración" },
        { title: "Acreditado" },
        { title: "Banco Origen" },
    ...
    $("#reconsideracionConcluidas tbody").on("click", ".btn-eliminar", function () {
    ...
    $("#reconsideracionConcluidas tbody").on("click", ".btn-editar", function () {
